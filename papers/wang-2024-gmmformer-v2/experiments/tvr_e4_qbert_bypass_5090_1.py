...
cfg["root"] = os.environ.get(
    "PRVR_ROOT",
    "/data/zhaopu/wang-2024-gmmformer-v2/tmp/tvr_i3d_cliptext_qbert_bypass_seed9527",
)
cfg["data_root"] = "/data/zhaopu/wang-2024-gmmformer-v2/data/prvr"

# Parent E4 178.6: I3D+ResNet vis, CLIP token text. One change: bypass query BertAttention.
