...
cfg["root"] = os.environ.get(
    "PRVR_ROOT", "/data/zhaopu/wang-2024-gmmformer-v2/tmp/tvr_i3d_cliptext_e4_seed9527"
)
cfg["data_root"] = "/data/zhaopu/wang-2024-gmmformer-v2/data/prvr"

# E4 structure: MS-SL I3D+ResNet visual + E2 CLIP projected token text. Not Table 1.
