...
cfg["root"] = os.environ.get(
    "PRVR_ROOT",
    "/data/zhaopu/wang-2024-gmmformer-v2/tmp/tvr_i3d_cliptext_e4_sft06_seed9527",
)
cfg["data_root"] = "/data/zhaopu/wang-2024-gmmformer-v2/data/prvr"

# E4 structure, one-knob sft_factor: 0.09 -> 0.6. Parent E4 lr stays 3e-4. Not Table 1.
