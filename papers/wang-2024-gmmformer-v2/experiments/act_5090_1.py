...
cfg["model_name"] = "gmmformer_v2"
cfg["dataset_name"] = "activitynet"
cfg["seed"] = int(os.environ.get("PRVR_SEED", "9527"))
cfg["root"] = os.environ.get(
    "PRVR_ROOT", "/data/zhaopu/wang-2024-gmmformer-v2/tmp/act_i3d_seed9527"
)
cfg["data_root"] = "/data/zhaopu/wang-2024-gmmformer-v2/data/prvr"

# Official Table 1 ActivityNet: MS-SL I3D + RoBERTa. Do not copy cha.py CLIP/E4.
...
cfg["loss_factor"] = [0.02, 0.04, 0.003, 0.11]
...
cfg["max_desc_l"] = 30
cfg["max_ctx_l"] = 128
# T1-act: RoBERTa 1024. E4: CLIP proj 512 when PRVR_ROOT is the e4 tmp dir.
_E4 = "i3d_cliptext_e4" in os.environ.get("PRVR_ROOT", "")
cfg["sub_feat_size"] = 512 if _E4 else 768
cfg["q_feat_size"] = 512 if _E4 else 1024
